import React, { useState, useCallback, useEffect } from "react";
        ...
        const Home = () => {
            ...
            const handleTopStudentsVisibility = () => {
                // Removed the state toggle as it's not needed anymore
            };
                                ...
                                <Paper elevation={3} sx={{ p: 2, mb: 3 }}>
                                    ...
                                    {topStudentsTab === 0 && report.topper && (
                                        <Box display="flex" justifyContent="space-around" alignItems="center">
                                            <StudentCard title="🌟 Topper" student={report.topper} color={vibrantPalette[0]} />
                                            ...
                                            <Grid container spacing={2} justifyContent="center" mb={2}>
                                                {report.top3.map((student, index) => (
                                                    <Grid item key={student.name}>
                                                        <StudentCard title={`🥇 Rank ${index + 1}`} student={student} color={vibrantPalette[1]} />
                                                    </Grid>
                                                ))}
                                            </Grid>
                                        ...
                                        <Box>
                                            <Grid container spacing={2} justifyContent="center" mb={2}>
                                                {report.bottom3.map((student, index) => (
                                                    <Grid item key={student.name}>
                                                        <StudentCard title={`📉 Bottom ${index + 1}`} student={student} color={vibrantPalette[7]} />
                                                    </Grid>
                                                ))}
                                            </Grid>
